...
A brief description of each R file in the package is provided below. A more detailed description for each function (including a description of input parameters) is provided in separate vignettes.
