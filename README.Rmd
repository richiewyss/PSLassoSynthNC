...
Below, we provide an example running the full analytic pipeline from PS estimation, PS model selection/undersmoothing, treatment effect estimation, and diagnostic assessment for one simulation run.
...
Examples for running each of the helper functions listed above are provided in separate vignettes.
